export default () => {
    ...
    const testimonials = [
        {
            ...
            name: "Rald Blox",
            title: "Founder of Cuteness",
            quote: "Om nom nom nom ompp ommpo ompp ommmpoo opoooh ompo nomnom nommm grRRRrrrr"
        },
        {
            avatar: "https://randomuser.me/api/portraits/women/79.jpg",
            name: "Danki danki",
            title: "Donkey Engineer",
            quote: "Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit."
        },
        {
            avatar: "https://randomuser.me/api/portraits/men/86.jpg",
            name: "Jay Dee",
            title: "Rawr Scientist",
    ...
    return (
        <section className="relative py-14">
                    ...
                    <ul className="grid items-center gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        {
                            testimonials.map((item, idx) => (
                                <li key={idx} className="bg-white rounded-xl border shadow-md">
                                    <div className="p-4">
                                        <svg className="w-9 h-9 text-orange-200" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <figure>
                                        ...
                                        <div className="flex items-center gap-x-4 p-4 mt-6 bg-orange-50">
                                            <img src={item.avatar} className="w-16 h-16 rounded-full border-2 border-orange-500" />
                                            <div>
                                                <span className="block text-gray-800 font-semibold">{item.name}</span>
                                                <span className="block text-orange-600 text-sm mt-0.5">{item.title}</span>
                                            </div>
                                        </div>
                                    </figure>
                                </li>
            ...
            <div className="absolute top-0 w-full h-[350px] bg-gradient-to-b from-orange-100 to-orange-50"></div>
        </section>
    )
}