            ...
            <div className="max-w-screen-xl gap-12 px-4 mx-auto text-gray-600 py-28 md:px-8 xl:flex">
                <div className="flex flex-col max-w-2xl mx-auto space-y-5 text-center xl:text-left lg:justify-center">
                    ...
                    <div className="items-center justify-center space-y-3 gap-x-3 sm:flex sm:space-y-0 xl:justify-start">
                        ...
                        <Link href="/marketplace/upload" className="flex items-center justify-center px-4 py-2 font-medium text-gray-700 duration-150 border rounded-lg gap-x-2 hover:text-gray-500 active:bg-gray-100 md:inline-flex">
                            Upload Files
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
                                <path fillRule="evenodd" d="M2 10a.75.75 0 01.75-.75h12.59l-2.1-1.95a.75.75 0 111.02-1.1l3.5 3.25a.75.75 0 010 1.1l-3.5 3.25a.75.75 0 11-1.02-1.1l2.1-1.95H2.75A.75.75 0 012 10z" clipRule="evenodd" />
                            </svg>
                ...
                <div className="flex-1 max-w-xl mx-auto mt-14 xl:mt-0">
                    <div className='flex-1'>
                        <img src="/undraw-assets/upload.svg" className="lg:max-w-xl" />
                    </div>
                </div>
            </div>
        </section>
