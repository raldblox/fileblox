...
export default () => {
    ...
    const navigation = [
        { title: "Discover", path: "javascript:void(0)", isDrapdown: true, navs: dropdownNavs },
        { title: "Marketplace", path: "javascript:void(0)", isDrapdown: false },
        { title: "Featured Collection", path: "javascript:void(0)", isDrapdown: false },
