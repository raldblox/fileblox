                    ...
                    <div className={`nav-menu flex-1 pb-3 mt-8 md:block md:pb-0 md:mt-0 ${state ? 'block' : 'hidden'}`}>
                        <ul className="items-center space-y-6 text-base md:flex md:space-x-6 md:space-y-0">
                                        ...
                                        <li key={idx}>
                                            {
                                                item.isDrapdown ? (
                                                    ...
                                                    <a href={item.path} className="block text-gray-700 hover:text-orange-600">
                                                        {item.title}
                                                    </a>
                                                )
                                            }
                            ...
                            <div className='items-center justify-end flex-1 space-y-3 gap-x-6 md:flex md:space-y-0'>
                                <li>
                                    <Link href="/dashboard" className="block py-3 text-center text-gray-700 border border-gray-400 rounded-lg hover:text-orange-600 md:border-none">
                                        Dashboard
                                    </Link>
                                </li>
